...
import com.udacity.gradle.builditbigger.paid.VersionActivity;
...
public class BackendReturnDataTest {
    ...
    public void registerIdlingResource() {
        ...
        mFrag = (MainActivityFragment) mActivityTestRule.getActivity().getSupportFragmentManager()
                .findFragmentById(R.id.fragment);
        mIdlingResource = mFrag.getmIdlingRes();
